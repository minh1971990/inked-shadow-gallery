...
export const BookingForm: React.FC<BookingFormProps> = ({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={(open) => !open && resetForm()}>
      <DialogContent className="sm:max-w-[600px] bg-black/95 dark:bg-white/95 border border-white/10 dark:border-black/10 backdrop-blur-md p-0 rounded-xl overflow-hidden">
        <div className="p-4">
          <DialogHeader>
            <DialogTitle className="text-2xl font-bold text-white dark:text-black text-center">
              Book Your ConsultationF
            </DialogTitle>
          </DialogHeader>
